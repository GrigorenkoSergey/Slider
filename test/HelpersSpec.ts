import { EventObserver, ISubscriber } from "../src/assets/blocks/mySlider/Helpers";

describe("EventObserver\n", () => {
    let observer: EventObserver,
        subscriber1: ISubscriber,
        subscriber2: ISubscriber;
    ...
    it("Корректно сохраняет в памяти подписчиков", () => {
        expect(observer.observers.mousedown).toEqual(jasmine.arrayContaining([subscriber1, subscriber2]));
        expect(observer.observers.mouseup).toEqual([subscriber2]);
    });
